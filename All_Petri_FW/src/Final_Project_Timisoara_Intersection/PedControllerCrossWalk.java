...
public class PedControllerCrossWalk {
        public static void main (String []args) {
            ...
            p6.SetName("CarSCrossWalk");
            p6.Value = new TransferOperation("localhost", "1080" , "CarSCrossWalk");
            pn.PlaceList.add(p6);

            DataTransfer p7 = new DataTransfer();
            p7.SetName("PedSCrossWalk");
            p7.Value = new TransferOperation("localhost", "1080" , "PedSCrossWalk");
            pn.PlaceList.add(p7);
            ...
            grdiniT.Activations.add(new Activation(iniT, "green", TransitionOperation.SendOverNetwork, "CarSCrossWalk"));
            grdiniT.Activations.add(new Activation(iniT, "red", TransitionOperation.SendOverNetwork, "PedSCrossWalk"));
            ...
            grdT1.Activations.add(new Activation(t1, "yellow", TransitionOperation.SendOverNetwork, "CarSCrossWalk"));
            ...
            grdT2.Activations.add(new Activation(t2, "red", TransitionOperation.SendOverNetwork, "CarSCrossWalk"));
            grdT2.Activations.add(new Activation(t2, "green", TransitionOperation.SendOverNetwork, "PedSCrossWalk"));
            ...
            grdT3.Activations.add(new Activation(t3, "yellow", TransitionOperation.SendOverNetwork, "PedSCrossWalk"));
            ...
            grdT4.Activations.add(new Activation(t4, "red", TransitionOperation.SendOverNetwork, "PedSCrossWalk"));
            grdT4.Activations.add(new Activation(t4, "green", TransitionOperation.SendOverNetwork, "CarSCrossWalk"));
