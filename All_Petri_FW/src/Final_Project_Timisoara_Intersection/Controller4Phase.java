...
public class Controller4Phase {
    public static void main (String []args) {
        ...
        p10.SetName("OP1");
        p10.Value = new TransferOperation("localhost", "1080" , "pca_ptl1");
        pn.PlaceList.add(p10);

        DataTransfer p11 = new DataTransfer();
        p11.SetName("OP2");
        p11.Value = new TransferOperation("localhost", "1080" , "pca_ptl2");
        pn.PlaceList.add(p11);

        DataTransfer p12 = new DataTransfer();
        p12.SetName("OP3");
        p12.Value = new TransferOperation("localhost", "1080" , "pca_ptl3");
        pn.PlaceList.add(p12);

        DataTransfer p13 = new DataTransfer();
        p13.SetName("OP4");
        p13.Value = new TransferOperation("localhost", "1080" , "pca_ptl4");
        ...
        Condition t_f1Ct3 = new Condition(t_f1, "in1", TransitionCondition.IsNull);
        ...
        Condition t_f1Ct6 = new Condition(t_f1, "in1", TransitionCondition.NotNull);
        t_f1Ct4.SetNextCondition(LogicConnector.AND, t_f1Ct6);
        ...
        Condition t_f2Ct3 = new Condition(t_f2, "in2", TransitionCondition.IsNull);
        ...
        Condition t_f2Ct6 = new Condition(t_f2, "in2", TransitionCondition.NotNull);
        t_f2Ct4.SetNextCondition(LogicConnector.AND, t_f2Ct6);
        ...
        Condition t_f3Ct3 = new Condition(t_f3, "in3", TransitionCondition.IsNull);
        ...
        Condition t_f3Ct6 = new Condition(t_f3, "in3", TransitionCondition.NotNull);
        t_f3Ct4.SetNextCondition(LogicConnector.AND, t_f3Ct6);

        GuardMapping grdT_f32 = new GuardMapping();
        grdT_f32.condition = t_f3Ct4;
...
//----------------------------T_f4------------------------------------
        ...
        Condition t_f4Ct3 = new Condition(t_f4, "in4", TransitionCondition.IsNull);
        ...
        Condition t_f4Ct6 = new Condition(t_f4, "in4", TransitionCondition.NotNull);
        t_f4Ct4.SetNextCondition(LogicConnector.AND, t_f4Ct6);

        GuardMapping grdT_f42 = new GuardMapping();
        grdT_f42.condition = t_f4Ct4;
