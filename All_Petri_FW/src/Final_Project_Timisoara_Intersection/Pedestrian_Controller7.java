...
public class Pedestrian_Controller7 {
        ...
        public static void main (String []args) {
            ...
            p6.SetName("P_TL");
            p6.Value = new TransferOperation("localhost", "1080" , "pca_ptl7");
            pn.PlaceList.add(p6);

            DataTransfer p7 = new DataTransfer();
            p7.SetName("P_PTL");
            p7.Value = new TransferOperation("localhost", "1080" , "pca_pptl7");
            pn.PlaceList.add(p7);
            ...
            t1.InputPlaceName.add("pca_userreq7");
            t1.InputPlaceName.add("wait");

            Condition T1Ct1 = new Condition(t1, "pca_userreq7", TransitionCondition.NotNull);
