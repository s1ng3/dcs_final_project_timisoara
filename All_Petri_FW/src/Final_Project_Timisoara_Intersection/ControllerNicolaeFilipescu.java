...
public class ControllerNicolaeFilipescu {
        ...
        public static void main(String[] args) {
            ...
            p10.SetName("OP1");
            p10.Value = new TransferOperation("localhost", "1080", "SemNF");
            pn.PlaceList.add(p10);

            DataTransfer p11 = new DataTransfer();
            p11.SetName("OP2");
            p11.Value = new TransferOperation("localhost", "1080", "SemBrEnterRight");
            pn.PlaceList.add(p11);

            DataTransfer p12 = new DataTransfer();
            p12.SetName("OP3");
            p12.Value = new TransferOperation("localhost", "1080", "SemBREastRightEn");
