...
public class Pedestrian_ControllerTramRight {
        ...
        public static void main (String []args) {
            ...
            p6.SetName("TramPedSem");
            p6.Value = new TransferOperation("localhost", "1080" , "TramPedSem");
            pn.PlaceList.add(p6);

            DataTransfer p7 = new DataTransfer();
            p7.SetName("PedTramEnterRight");
            p7.Value = new TransferOperation("localhost", "1080" , "PedTramEnterRight");
            pn.PlaceList.add(p7);
            ...
            grdiniT.Activations.add(new Activation(iniT, "green", TransitionOperation.SendOverNetwork, "TramPedSem"));
            grdiniT.Activations.add(new Activation(iniT, "red", TransitionOperation.SendOverNetwork, "PedTramEnterRight"));
            ...
            grdT1.Activations.add(new Activation(t1, "yellow", TransitionOperation.SendOverNetwork, "TramPedSem"));
            ...
            grdT2.Activations.add(new Activation(t2, "red", TransitionOperation.SendOverNetwork, "TramPedSem"));
            grdT2.Activations.add(new Activation(t2, "green", TransitionOperation.SendOverNetwork, "PedTramEnterRight"));
            ...
            grdT3.Activations.add(new Activation(t3, "yellow", TransitionOperation.SendOverNetwork, "PedTramEnterRight"));
            ...
            grdT4.Activations.add(new Activation(t4, "red", TransitionOperation.SendOverNetwork, "PedTramEnterRight"));
            grdT4.Activations.add(new Activation(t4, "green", TransitionOperation.SendOverNetwork, "TramPedSem"));
